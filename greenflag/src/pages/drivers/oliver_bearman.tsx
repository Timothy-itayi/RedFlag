...
const driverNumber = '38'; // Assuming Logan Sargeant has driver number 2

const Oliver_Bearman = () => {
  return (
    <>
          ...
          <CardContainer className="inter-var" teamColor={teamColors["Ferrari"]}>
            <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto h-auto rounded-xl p-6 border">
              ...
              <CardItem translateZ="100" className="w-full mt-4">
                <Image
                  src="/current_drivers/olibea01.avif" // Make sure to provide the imageUrl
                  height="1000"
                  width="1000"
