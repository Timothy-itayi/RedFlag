...
const driverNumber = '22'; // Assuming Logan Sargeant has driver number 2
          ...
          <CardContainer className="inter-var" teamColor={teamColors["RB"]}>
            ...
            Yuki Tsunoda 
              ...
              <CardItem translateZ="100" className="w-full mt-4">
                <Image
                  src="/current_drivers/yuktsu01.avif" // Make sure to provide the imageUrl
                  height="1000"
                  width="1000"
